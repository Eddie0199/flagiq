...
const STRINGS = {
  en: {
    ...
    homeAccountBenefits: "Save your progress, keep your coins safe, and play across devices.",
    chooseGameMode: "Choose Game Mode",
    modeSelectionTitle: "Choose your mode",
    modeSelectionSubtitle: "Pick a mode and start playing",
    futureModeLabel: "More modes coming soon",
    guestModeHelper: "Sign in to save progress and compete on leaderboards",
    restorePurchases: "Restore Purchases",
    deleteAccount: "Delete Account",
    deleteAccountConfirmTitle: "Permanently delete account?",
    deleteAccountConfirmBody: "This action cannot be undone. Your account will be permanently deleted, and you will be signed out.",
    deleteAccountConfirmAction: "Yes, delete account",
    deleteAccountSuccess: "Your account has been permanently deleted.",
    deleteAccountErrorGeneric: "We could not delete your account right now. Please try again.",
    deleteAccountMustLogin: "You must be logged in to delete your account.",
    guestProgressPromptTitle: "Save your progress",
    guestProgressPromptBody: "You completed {{milestone}} levels. Create an account to keep your progress, coins, and purchases safe.",
    maybeLater: "Maybe Later",
    deleting: "Deleting...",
    cancel: "Cancel",
    guestPurchaseAccountPrompt: "Create an account to save your progress and purchases across devices",
...
"auth.passwordReuseError": "You cannot use a previous password. Please choose a new password.",
  ...
  es: {
    ...
    homeAccountBenefits: "Guarda tu progreso, protege tus monedas y juega en varios dispositivos.",
    chooseGameMode: "Elegir modo de juego",
    modeSelectionTitle: "Elige tu modo",
    modeSelectionSubtitle: "Selecciona un modo y empieza a jugar",
    futureModeLabel: "Próximamente más modos",
    guestModeHelper: "Inicia sesión para guardar tu progreso y competir en las clasificaciones",
    restorePurchases: "Restaurar compras",
    deleteAccount: "Eliminar cuenta",
    deleteAccountConfirmTitle: "¿Eliminar la cuenta de forma permanente?",
    deleteAccountConfirmBody: "Esta acción no se puede deshacer. Tu cuenta se eliminará de forma permanente y se cerrará tu sesión.",
    deleteAccountConfirmAction: "Sí, eliminar cuenta",
    deleteAccountSuccess: "Tu cuenta ha sido eliminada permanentemente.",
    deleteAccountErrorGeneric: "No pudimos eliminar tu cuenta ahora. Inténtalo de nuevo.",
    deleteAccountMustLogin: "Debes iniciar sesión para eliminar tu cuenta.",
    guestProgressPromptTitle: "Guarda tu progreso",
    guestProgressPromptBody: "Completaste {{milestone}} niveles. Crea una cuenta para proteger tu progreso, monedas y compras.",
    maybeLater: "Quizás más tarde",
    deleting: "Eliminando...",
    cancel: "Cancelar",
    guestPurchaseAccountPrompt: "Crea una cuenta para guardar tu progreso y compras en todos tus dispositivos",
...
"auth.passwordReuseError": "No puedes usar una contraseña anterior. Elige una contraseña nueva.",
  ...
  pt: {
    ...
    homeAccountBenefits: "Guarda o teu progresso, mantém as tuas moedas seguras e joga em vários dispositivos.",
    chooseGameMode: "Escolher modo de jogo",
    modeSelectionTitle: "Escolhe o teu modo",
    modeSelectionSubtitle: "Seleciona um modo e começa a jogar",
    futureModeLabel: "Mais modos em breve",
    guestModeHelper: "Inicia sessão para guardar o progresso e competir nos rankings",
    restorePurchases: "Restaurar compras",
    deleteAccount: "Eliminar conta",
    deleteAccountConfirmTitle: "Eliminar conta permanentemente?",
    deleteAccountConfirmBody: "Esta ação não pode ser desfeita. A tua conta será eliminada permanentemente e terminarás sessão.",
    deleteAccountConfirmAction: "Sim, eliminar conta",
    deleteAccountSuccess: "A tua conta foi eliminada permanentemente.",
    deleteAccountErrorGeneric: "Não foi possível eliminar a tua conta agora. Tenta novamente.",
    deleteAccountMustLogin: "Tens de iniciar sessão para eliminar a tua conta.",
    guestProgressPromptTitle: "Guarda o teu progresso",
    guestProgressPromptBody: "Concluíste {{milestone}} níveis. Cria uma conta para proteger o teu progresso, moedas e compras.",
    maybeLater: "Talvez mais tarde",
    deleting: "A eliminar...",
    cancel: "Cancelar",
    guestPurchaseAccountPrompt: "Cria uma conta para guardar o teu progresso e compras entre dispositivos",
...
"auth.passwordReuseError": "Não pode reutilizar uma palavra-passe anterior. Escolha uma nova palavra-passe.",
  ...
  de: {
    ...
    homeAccountBenefits: "Speichere deinen Fortschritt, sichere deine Münzen und spiele auf mehreren Geräten.",
    chooseGameMode: "Spielmodus wählen",
    modeSelectionTitle: "Wähle deinen Modus",
    modeSelectionSubtitle: "Wähle einen Modus und lege los",
    futureModeLabel: "Weitere Modi folgen",
    guestModeHelper: "Melde dich an, um Fortschritt zu speichern und in Ranglisten anzutreten",
    restorePurchases: "Käufe wiederherstellen",
    deleteAccount: "Konto löschen",
    deleteAccountConfirmTitle: "Konto dauerhaft löschen?",
    deleteAccountConfirmBody: "Diese Aktion kann nicht rückgängig gemacht werden. Dein Konto wird dauerhaft gelöscht und du wirst abgemeldet.",
    deleteAccountConfirmAction: "Ja, Konto löschen",
    deleteAccountSuccess: "Dein Konto wurde dauerhaft gelöscht.",
    deleteAccountErrorGeneric: "Dein Konto konnte gerade nicht gelöscht werden. Bitte versuche es erneut.",
    deleteAccountMustLogin: "Du musst angemeldet sein, um dein Konto zu löschen.",
    guestProgressPromptTitle: "Fortschritt speichern",
    guestProgressPromptBody: "Du hast {{milestone}} Level abgeschlossen. Erstelle ein Konto, um Fortschritt, Münzen und Käufe zu sichern.",
    maybeLater: "Vielleicht später",
    deleting: "Wird gelöscht...",
    cancel: "Abbrechen",
    guestPurchaseAccountPrompt: "Erstelle ein Konto, um Fortschritt und Käufe geräteübergreifend zu speichern",
...
"auth.passwordReuseError": "Du kannst kein früheres Passwort verwenden. Bitte wähle ein neues Passwort.",
  ...
  fr: {
    ...
    homeAccountBenefits: "Sauvegardez votre progression, protégez vos pièces et jouez sur plusieurs appareils.",
    chooseGameMode: "Choisir un mode",
    modeSelectionTitle: "Choisissez votre mode",
    modeSelectionSubtitle: "Sélectionnez un mode et commencez à jouer",
    futureModeLabel: "D'autres modes arrivent bientôt",
    guestModeHelper: "Connectez-vous pour sauvegarder votre progression et participer aux classements",
    restorePurchases: "Restaurer les achats",
    deleteAccount: "Supprimer le compte",
    deleteAccountConfirmTitle: "Supprimer définitivement le compte ?",
    deleteAccountConfirmBody: "Cette action est irréversible. Votre compte sera supprimé définitivement et vous serez déconnecté.",
    deleteAccountConfirmAction: "Oui, supprimer le compte",
    deleteAccountSuccess: "Votre compte a été supprimé définitivement.",
    deleteAccountErrorGeneric: "Nous n'avons pas pu supprimer votre compte pour le moment. Veuillez réessayer.",
    deleteAccountMustLogin: "Vous devez être connecté pour supprimer votre compte.",
    guestProgressPromptTitle: "Sauvegardez votre progression",
    guestProgressPromptBody: "Vous avez terminé {{milestone}} niveaux. Créez un compte pour protéger votre progression, vos pièces et vos achats.",
    maybeLater: "Peut-être plus tard",
    deleting: "Suppression...",
    cancel: "Annuler",
    guestPurchaseAccountPrompt: "Créez un compte pour sauvegarder votre progression et vos achats sur tous vos appareils",
...
"auth.passwordReuseError": "Vous ne pouvez pas réutiliser un ancien mot de passe. Veuillez en choisir un nouveau.",
  ...
  nl: {
    ...
    playAsGuest: "Als gast spelen",
    signInCreateAccount: "Inloggen / Account maken",
    homeAccountBenefits: "Sla je voortgang op, houd je munten veilig en speel op meerdere apparaten.",
    chooseGameMode: "Spelmodus kiezen",
    modeSelectionTitle: "Kies je modus",
    modeSelectionSubtitle: "Kies een modus en begin met spelen",
    futureModeLabel: "Meer modi komen eraan",
    guestModeHelper: "Log in om voortgang op te slaan en mee te doen aan ranglijsten",
    restorePurchases: "Aankopen herstellen",
    deleteAccount: "Account verwijderen",
    deleteAccountConfirmTitle: "Account permanent verwijderen?",
    deleteAccountConfirmBody: "Deze actie kan niet ongedaan worden gemaakt. Je account wordt permanent verwijderd en je wordt uitgelogd.",
    deleteAccountConfirmAction: "Ja, account verwijderen",
    deleteAccountSuccess: "Je account is permanent verwijderd.",
    deleteAccountErrorGeneric: "We konden je account nu niet verwijderen. Probeer het later opnieuw.",
    deleteAccountMustLogin: "Je moet ingelogd zijn om je account te verwijderen.",
    guestProgressPromptTitle: "Sla je voortgang op",
    guestProgressPromptBody: "Je hebt {{milestone}} levels voltooid. Maak een account om je voortgang, munten en aankopen te bewaren.",
    maybeLater: "Misschien later",
    deleting: "Bezig met verwijderen...",
    cancel: "Annuleren",
    guestPurchaseAccountPrompt: "Maak een account om je voortgang en aankopen op al je apparaten op te slaan",
